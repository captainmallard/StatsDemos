...
## How do we know if `A` and `B` are independent?
Well, there are a couple of equivalent definitions for two events to be *independent*.

1. `P(A|B) = P(A)` *and/or* `P(B|A) = P(B)`
...
We can use any of these defintion to test if two events `A` and `B` are independent! Cool, right?
"""
...
RedMarblePicture = load("/home/pdc/Desktop/Teaching/Clemson_Fall_2024/RedMarble.jpg");

# ╔═╡ ccd33e97-d461-40e4-9332-009f24f31545
BlueMarblePicture = load("/home/pdc/Desktop/Teaching/Clemson_Fall_2024/BlueMarble.jpg");

# ╔═╡ a2b40a8f-3095-4fac-8e2b-d9e5140a05c0
HourGlassPicture = load("/home/pdc/Desktop/Teaching/Clemson_Fall_2024/Hourglass1.jpg");

# ╔═╡ 4af8ff80-5dc6-4e6c-a67e-070cf00b41e4
YellowMarblePicture = load("/home/pdc/Desktop/Teaching/Clemson_Fall_2024/YellowMarble.jpg");
...
df₀ = DataFrame(CSV.File("/home/pdc/Desktop/Teaching/Clemson_Fall_2024/Heart_Disease_Prediction.csv"))
...
HeadsPicture = load("/home/pdc/Desktop/Teaching/Clemson_Fall_2024/Heads.png");

# ╔═╡ 7d001ab6-cd1f-45e6-a25f-a14c7bc5d121
# Load picture of Tails
TailsPicture = load("/home/pdc/Desktop/Teaching/Clemson_Fall_2024/Tails.png");
